...
public class MainModel
{
    ...
    private ObservableList<TaskModel> tasksList = FXCollections.observableArrayList(
            new TaskModel("Task1", LocalDate.now().plusDays(1), 30, "V: This Week"),
            new TaskModel("Task2", LocalDate.now(), 30, "V: Today"),
            new TaskModel("Task3", LocalDate.now().minusMonths(1), 50, "V: Overdue"));
